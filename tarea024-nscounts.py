...
report = wikipedia.Page(site, u'Wikipedia:Informes automáticos/Número de páginas por espacio de nombres')
report.put(report_template % ('\n'.join(output), ns_count_tcol, ns_count_r_tcol, ns_count_gtotal), u'BOT - Actualizando informe', None, False)
cursor.close()
conn.close()
