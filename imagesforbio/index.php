...
echo "<div style='position: absolute; right:5px; top:5px;'>[ <a href='stats.php'>Statistics</a> ]</div><center><table style='text-align:center;'><tr><td><img src='im1.jpg'></td><td><h1><a href='http://toolserver.org/~emijrp/imagesforbio/'>Images for biographies</a></h1></td><td><img src='im2.png'></td></tr></table></center><center><b>PLEASE! Check images before insert them. Do not insert images not related with the article subject. Thanks.</b><br/>You can help <a href='http://en.wikipedia.org/wiki/User:BOTijo/Images_for_biographies'>translating this tool</a> and reporting <a href='http://en.wikipedia.org/wiki/User_talk:Emijrp/Images_for_biographies/Exclusions'>wrong image&lt;---&gt;article</a> relations. Send any comments to <a href='http://en.wikipedia.org/wiki/User:Emijrp'>emijrp</a>.<br/><b>How to use this tool?</b> 1) Choose an image. 2) Press \"Add image to page\" (if the image is correct). 3) The Wikipedia article is loaded in a new tab. 4) If the article has an infobox template, move the image into the infobox. 5) Save changes pressing the save button. 6) Click \"Mark as done\" button to remove the image from this list.</center><hr/><center><b>Select a language:</b> <a href=index.php?language=all>All</a>";
...
echo "<hr/><center>This tool has been developed by <a href='http://tools.wikimedia.de/~emijrp/'>emijrp</a> (some functions by <a href='http://tools.wikimedia.de/~magnus/'>magnus</a>)<br/>Total visits: ";

include ('../visits.php');

echo "<br/><a href='http://tools.wikimedia.de/'><img src='wikimedia-toolserver-button.png'></a></center>";
echo "</body></html>";
?>
