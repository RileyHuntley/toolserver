...
def main():
    global langs
    languages = langs
    for language in languages: #mientras encuentro una forma de que no gaste tanta ram, #fix
        langs = [language]
        for lang in langs:
            lang = lang.lower()
        ...
        for gz in gzs:
            ...
            for line in f:
                ...
                if c % 250000 == 0:
                    ...
                    print "%d idiomas encontrados: %s" % (len(pagesdic.keys()), ', '.join(pagesdic.keys()))
